...
const roleBadges = [
  { label: "Sr Product Designer", variant: "blue" as const },
  { label: "UI/UX Design", variant: "purple" as const },
  { label: "AI Design", variant: "orange" as const },
  { label: "User Research", variant: "teal" as const },
]
