...
export function Navbar() {
  ...
  const handleLinkClick = (href: string, sectionId: string | null) => {
  ...
  return (
    ...
    >
      <div className="h-16 px-6 md:px-12 flex items-center justify-between">
        {/* Logo - Left */}
        <Link href="/" className="text-lg font-semibold logo-font text-gray-900 font-sans" onClick={() => window.scrollTo(0, 0)}>
          ⵃⵎⵉⵎⵉ
        </Link>
        ...
        <div className="flex items-center gap-4">
          <Button size="sm" className="hidden lg:inline-flex">
            <a href="#contact" onClick={(e: React.MouseEvent) => { e.preventDefault(); handleLetsTalk() }}>Let&apos;s Talk</a>
          </Button>
