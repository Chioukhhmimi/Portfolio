...
function BlogPostClient() {
    ...
    const post = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolio"].blogPosts?.find((p)=>p.title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "") === slug);
    if (!post) {
    ...
    const relatedPosts = (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolio"].blogPosts || []).filter((p)=>p.id !== post.id).slice(0, 2);
...
_s(BlogPostClient, "+jVsTcECDRo3yq2d7EQxlN9Ixog=", false, function() {
    return [
...
//# sourceMappingURL=_06k7j6p._.js.map